...
class UsulanPolicy
{
    ...
    {
        return $user->can('force_delete_usulans::usulan');
    }
    ...
    {
        return $user->can('force_delete_any_usulans::usulan');
    }
    ...
    {
        return $user->can('restore_usulans::usulan');
    }
    ...
    {
        return $user->can('restore_any_usulans::usulan');
    }
    ...
    {
        return $user->can('replicate_usulans::usulan');
    }
    ...
    {
        return $user->can('reorder_usulans::usulan');
    }
}
